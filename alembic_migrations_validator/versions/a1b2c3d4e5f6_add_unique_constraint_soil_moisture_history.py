...
def upgrade() -> None:
    ...
    if duplicates:
        print(
            f"Found {len(duplicates)} sets of duplicate records in soil_moisture_history"
        )
    ...
    if not constraint_exists(
        "soil_moisture_history", "uq_smh_region_miner_target_time"
    ):
        ...
        print(
            "Added unique constraint uq_smh_region_miner_target_time to soil_moisture_history"
        )
    else:
