...
def upgrade() -> None:
    ...
    print(
        f"Starting validator schema validation. Found {len(existing_tables)} existing tables."
    )
    ...
    try:
        ...
        wfr_cols = {
            col["name"] for col in inspector.get_columns("weather_forecast_runs")
        }
        ...
        wmr_cols = {
            col["name"] for col in inspector.get_columns("weather_miner_responses")
        }
