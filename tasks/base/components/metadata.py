...
class CoreMetadata(BaseModel):
    ...
    dependencies_file: str = Field(..., description="Path to the file containing the list of dependencies for this task or subtask.")
    hardware_requirements_file: str = Field(..., description="Path to the file containing the hardware requirements for this task or subtask. YML file.")
    author: str = Field(..., description="The name of the author of the task or subtask.")
...
class Metadata(BaseModel, ABC):
    ...
    def validate_metadata(self, core_metadata: Dict[str, Any], extended_metadata: Dict[str, Any]):
        '''
