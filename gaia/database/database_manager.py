...
class BaseDatabaseManager(ABC):
        ...
        if not hasattr(self, "initialized"):
            ...
            if resolved_connection_type == "socket":
                ...
                if (
                    ...
                    logger.warning(
                        "TCP connection type specified, but port is None. Defaulting to 5432."
                    )
                    actual_port = 5432
        ...
        try:
            ...
            if pool:
                ...
                if overflow > 0 or checkedin > size * 0.8:
                    ...
                    ):  # This will use a session with op_name
    ...
    async def execute_with_retry(
        ...
        last_error = None
        op_name = (
            f"execute_with_retry:{query[:80]}"  # Shorter op_name for retry wrapper
        )
    ...
    async def reset_pool(self) -> None:
        try:
            ...
            )  # This sets _engine_initialized to True on success
