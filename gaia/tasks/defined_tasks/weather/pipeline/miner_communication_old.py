...
async def query_single_miner(
    ...
    Args:
        ...
        db_manager: Database manager instance (uses validator.db_manager if not provided)
    ...
    # Get miner details - use provided db_manager or fall back to validator's
    ...
    for attempt in range(max_retries + 1):
        try:
            ...
            # Create a new client for each request to avoid reuse issues
