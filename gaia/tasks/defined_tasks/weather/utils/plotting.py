...
def plot_all_variables(ds, pressure_level=500):
    ...
    plot_settings = {
        ...
        "t": {
            "title": f"Temperature at {pressure_level}hPa (K)",
            "cmap": "RdBu_r",
            "vmin": 200,
            "vmax": 300,
        },
        "u": {
            "title": f"U-Wind at {pressure_level}hPa (m/s)",
            "cmap": "RdBu_r",
            "vmin": -50,
            "vmax": 50,
        },
        "v": {
            "title": f"V-Wind at {pressure_level}hPa (m/s)",
            "cmap": "RdBu_r",
            "vmin": -50,
            "vmax": 50,
        },
        "q": {
            "title": f"Specific Humidity at {pressure_level}hPa (kg/kg)",
            "cmap": "Blues",
            "vmin": 0,
            "vmax": 0.01,
        },
        "z": {
            "title": f"Geopotential at {pressure_level}hPa (m²/s²)",
            "cmap": "terrain",
            "vmin": None,
            "vmax": None,
        },
