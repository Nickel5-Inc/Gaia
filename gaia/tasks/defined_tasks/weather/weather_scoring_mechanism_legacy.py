    ...
    try:
        ...
        if var_name == "z" and var_level == 500:
            ...
            if miner_mean < 10000:  # Much smaller than expected geopotential
                ...
                logger.info(
                    "[Day1Score] Unit check OK: Both miner and truth z500 appear to be geopotential (m²/s²)"
                )
...
async def precompute_climatology_cache(
    ...
    if use_async_processing and interpolation_tasks:
        ...
        try:
            ...
            for i, result in enumerate(interpolation_results):
                ...
                try:
                    ...
                    interpolated_da = xr.DataArray(
                        ...
                        attrs=dict(original_coords.get("lat", {}).attrs)
            ...
            logger.info(
                "✅ ASYNC PROCESSED climatology cache pre-computation completed!"
            )
            logger.info(
        ...
        logger.info("✅ SEQUENTIAL climatology cache pre-computation completed!")
