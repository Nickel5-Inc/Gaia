        ...
        try:
            with torch.no_grad():
                ...
                predictions = {
                    ...
                    "uncertainty_surface": outputs.get(
                        "uncertainty_surface", torch.zeros_like(outputs["surface_sm"])
                    )
                    .squeeze()
                    .cpu()
                    .numpy()
                    * mask,
                    "uncertainty_rootzone": outputs.get(
                        "uncertainty_rootzone", torch.zeros_like(outputs["rootzone_sm"])
                    )
                    .squeeze()
                    .cpu()
                    .numpy()
