...
class GaiaValidator:
    ...
    def setup_neuron(self) -> bool:
        ...
        try:
            ...
            if hasattr(self.args, "subtensor") and hasattr(
                ...
                self.subtensor_chain_endpoint = os.getenv(
    ...
    async def query_miners(
        self, payload: Optional[Inputs] = None, endpoint: str = None
    ) -> Outputs:
        ...
        for miner_hotkey, node in self.metagraph.nodes.items():
            ...
            try:
                ...
                if symmetric_key_str and symmetric_key_uuid:
                    ...
                    logger.info(
                        f"Geomagnetic request sent to {miner_hotkey}! Response: {resp.text}"
                    )
                else:
    ...
    async def main(self):
        ...
        ssl_context.verify_mode = (
            ssl.CERT_NONE
        )  # This is necessary for self-signed certs
