...
class BaseModelEvaluator:
    ...
    def __init__(self, db_manager=None, test_mode: bool = False):
        ...
        logger.info(f"BaseModelEvaluator initialized for weather task only. Using device: {self.device}")
    ...
    async def initialize_models(self):
        ...
        try:
            ...
            logger.info("Baseline model initialization complete (geomagnetic and soil moisture disabled)")
            return True
